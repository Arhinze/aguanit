                ...
                if(preg_match("/[^a-z0-9_]/i", $_POST["username"])){
                    ...
                    if(count($data)>0){// ~ that means.. user exists
                        ...
                        */
                        ...
                        $p_stmt->execute([$_POST["name"], $_POST['username'],$_POST["email"],$_POST['password1'],$referer,date("Y-m-d h:i:s", time()),"inactive"]);
...
<div class="sign-in-box">   <!-- sign-in-box class starts -->
    <form method="post" action=""> 
        ...
        <b style = "color:<?=$site_color_light?>;font-weight:bold;font-size:12px;margin:12px 0"><i class="fa fa-asterisk"></i> Do not miss out on the $Aguat Airdrop</b>
        <!-- Twitter Username -->
        <div class="new-input-div">
