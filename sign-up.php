...
<div class="sign-in-box">   <!-- sign-in-box class starts -->
    <form method="post" action=""> 
        ...
        <!-- AVAX Wallet Address -->
        <b style = "color:<?=$site_color_light?>;font-weight:bold;font-size:12px;margin:9px 0;text-align:right;width:100%"><i class="fa fa-question-circle"></i> where to get your $Aguat wallet address?</b>
        <div class="new-input-div">
