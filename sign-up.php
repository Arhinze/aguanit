...
<div class="dashboard_div" style="margin-top:90px"> <!-- dashboard_div class starts -->
    ...
    <div class="sign-in-box"><!-- sign-in-box class starts -->
        <form method="post" action=""> 
            ...
            <div style="border-radius:3px; border: 1px solid <?=$site_color_light?>;background-color:#fff;padding:2px 3px"><b style = "color:<?=$site_color_light?>;font-weight:bold;font-size:12px;margin:6px 0"><i class="fa fa-asterisk"></i> Do not miss out on the $Aguat Airdrop</b></div>
            <!-- Twitter Username -->
            <div class="new-input-div">
