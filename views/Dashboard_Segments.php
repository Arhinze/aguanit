...
class Dashboard_Segments extends Index_Segments{
    ...
    <div class="body">
        ...
        <ul class="menu-list"> 
            ...
            <li><a href="$site_mining_page_url/claim-airdrop" style="color:#fff;font-weight:bold;background-color:#0bee3ccc;padding:6px;border-radius:12px">Claim Airdrop</a></li>
