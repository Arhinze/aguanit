        ...
        <script>
            ...
            function claim_airdrop(){
                ...
                if(((wallet_add).length) > 5) {
                    ...
                    document.append ("<div class='invalid' style='font-weight:bold'>String too short to be \$AGUAT wallet address.<span style='float:right;margin:4px 18px'><i class='fa fa-times' onclick='hide_invalid_div()'></i></span></div>");
                }
            }
