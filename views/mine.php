...
if ($data){//$data from account-manager.php
    ...
    if ($mining_stat == "active"){
        ...
        $mining_hours_left = $mining_hours_left > 10 ?: "0$mining_hours_left";
        $mining_minutes_left = $mining_minutes_left > 10 ?: "0$mining_minutes_left";
        $mining_seconds_left = $mining_seconds_left > 10 ?: "0$mining_seconds_left";
