...
?>
    ...
    <center>
        ...
        <div style="font-size:30px;font-weight:bold;font-family:Arial;margin-bottom:30px"><img src="<?=$site_url?>/static/images/logo.png" style="width:60px;height:60px;margin-right:15px"/> <span id="amount_mined"><?=$amount_mined?></span></div>
