...
if((isset($_GET["un"])) && ((isset($_GET["up"])))){
    ...
    if ($data) {
        if ($data->mining_status != "active"){
            ...
            echo "<div class='pop_up'> Congrats, you've successfully initiated the mining cycle. <span style='float:right;position:absolute;top:6px;right:6px'><i class='fa fa-times' onclick='hide_invalid_div()'></i></span></div>";
        } else {
