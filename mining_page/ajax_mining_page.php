...
if((isset($_GET["un"])) && ((isset($_GET["up"])))){
    ...
    if ($data) {
        if ($data->mining_status != "active"){
            ...
            echo "<div class='pop_up'> Congrats, you've successfully initiated the mining cycle. <span style='float:left;margin:4px 18px'><i class='fa fa-times' onclick='close_pop_up()'></i></span></div>";
        } else {
