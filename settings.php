...
//Reset password
    if($data){ //$data variable from php/account-manager.php
        ...
        if (isset($_POST["edit_account_data"])){
            ...
            echo "<div class='pop_up'>Successfully updated account data <i style='fa fa-check-circle-o'></i><span style='float:right;position:absolute;top:6px;right:6px'><i class='fa fa-times' onclick='close_pop_up()'></i></span></div>";
        }
?>
